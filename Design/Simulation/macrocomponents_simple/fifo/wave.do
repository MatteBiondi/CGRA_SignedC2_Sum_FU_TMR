...
add wave -noupdate /fifo_tb/arstn_tb
add wave -noupdate /fifo_tb/data_in
add wave -noupdate /fifo_tb/valid_in
add wave -noupdate /fifo_tb/ready_downstream
add wave -noupdate /fifo_tb/sync_final_state
